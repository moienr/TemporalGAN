...
## Version 1.7: BAM at the first layer
"""

import torch
import torch.nn as nn
from submodules.gen_cnn_block import Block
from submodules.cbam import ChannelAttention, SpatialAttention
from submodules.bam import BAM
...
class Generator(nn.Module):
    ...
    def forward(self, s2: torch.Tensor , s1:torch.Tensor) -> torch.Tensor:
        ...
        d1_s2 = self.bam_init_s2(self.s2_initial(s2)) 
        ...
        d1_s1 = self.bam_init_s1(self.s1_initial(s1))
